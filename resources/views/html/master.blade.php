                        ...
                        <ul class="account-area">
                            ...
                            <li>
                                ...
                                <ul class="pull-right dropdown-menu dropdown-arrow dropdown-messages">
                                    <li>
                                        <a href="#">
                                            <img src="{{url(asset('public/assets/img/avatars/divyia.jpg'))}}" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{url(asset('public/assets/img/avatars/bing.png'))}}" class="message-avatar" alt="Microsoft Bing">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Bing.com
                                                </span>
                                    ...
                                    <li>
                                        <a href="#">
                                            <img src="{{url(asset('public/assets/img/avatars/adam-jansen.jpg'))}}" class="message-avatar" alt="Divyia Austin">
                                            <div class="message">
                                                <span class="message-sender">
                                                    Nicolas
                                                </span>
                ...
                <ul class="contacts-list">
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/divyia.jpg'))}}" />
                        </div>
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Nicolai-Larson.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/John-Smith.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Osvaldus-Valutis.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Javi-Jimenez.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Stephanie-Walter.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Sergey-Azovskiy.jpg'))}}" />
                        </div>
                        <div class="contact-info">
                    ...
                    <li class="contact">
                        <div class="contact-avatar">
                            <img src="{{url(asset('public/assets/img/avatars/Lee-Munroe.jpg'))}}" />
                        </div>
                        <div class="contact-info">
...
<script type="text/javascript" src="{!!asset('public/assets/js/jquery.pjax.js')!!}"></script>
